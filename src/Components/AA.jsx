  ...
  return (
    <div>
      <div className="mt-30 ml-10 h-10  ">
        <h1 className="md:w-[400px] h-[30px] md:text-[30px] text-[25px] w-[300px] ">Academic Achievements</h1>
        <hr className="bg-Helenmaroon w-[310px] h-[3px] mt-3" />
      </div>

      <div ref={ref} className="flex justify-evenly flex-wrap md:gap-10  gap-0 h-auto  mt-10 px-4 ">
        {Archives.map((archive) => (
          <div
            key={archive.id}
            className={`relative md:w-[361px] w-[320px] h-[300px] border-Helenmaroon border-[1px] rounded-bl-[10px] rounded-tl-[60px] rounded-br-[60px] rounded-tr-[10px] flex flex-col justify-center items-center mb-32 mt-15 text-center gap-7 p-4 ${archive.bgClass}`}
          >
          
            <div className="absolute top-0 right-0 translate-x-1/2  rotate-y-180  -translate-y-1/2  md:w-12 md:h-12 w-10 h-10 bg-Helenmaroon text-white border-4 border-white rounded-tl-3xl flex justify-center items-center z-50">
              <h1 className="text-3xl">“</h1>
            </div>

            
            <div className="absolute bottom-0 left-0 -translate-x-1/2 translate-y-1/2 md:w-12 md:h-12 w-10 h-10 bg-Helenmaroon text-white border-4 border-white rounded-tr-3xl flex justify-center items-center z-50 rotate-180">
              <h1 className="text-3xl">”</h1>
            </div>
