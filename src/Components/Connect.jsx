...
const Connect = () => {
  return (
    <div>
      <div className=" h-150 flex  justify-evenly mr-20 bg-white w-full overflow-hidden">
        <div className=" h-140 pt-15 flex flex-col  ">
          ...
          <p className="pt-5   w-[571px] h-[51px]">
          ...
          <div className="flex  flex-col  ">
            <div className="flex gap-2">
              ...
              <div>
                ...
                <p className="w-[462px] h-[16px] text-[10px]  mt-2">
        ...
        <div className="flex justify-center items-center min-h-screen bg-white  p-6 -mt-30">
          <div className="relative  z-20  ">
           ...
           <div className="absolute top-[90px] left-[-60px] bg-white w-[220px] h-[180px] rounded-lg" > </div>
            <div className=" bg-Helenmaroon w-[213px] h-[161px] absolute right-[250px] top-25 rounded-lg z-20">
