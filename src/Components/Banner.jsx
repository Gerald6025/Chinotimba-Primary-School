  ...
  return (
    <>
      <div className="flex flex-col md:flex-row h-auto md:h-[83vh] bg-white w-full flex-wrap ">
        <div className="pl-4 md:ml-15 pt-12 md:pt-45 mt-3  bg-center  bg-cover bg-gray-200 bg-blend-overlay h-auto md:h-120 w-full md:w-1/2 p-4 md:p-0 " style={{ backgroundImage: "url(images/Ab.PNG)" }}>
          ...
          <p className="text-[14px]  w-[300px] md:text-[16px]   md:w-[669px]">
        ...
        <div className="mt-6 md:mt-[80px] w-full md:w-[450px] h-auto md:h-[612px] ml-0 md:ml-10 flex justify-center">
          <img
            className="w-[90%] md:w-full h-120 object-contain  "
